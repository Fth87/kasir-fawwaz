...
interface CustomerContextType {
  customers: Customer[];
  isLoading: boolean;
  addCustomer: (customerData: NewCustomerInput) => Promise<boolean>;
...
export const CustomerProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addCustomer = useCallback(async (customerData: NewCustomerInput): Promise<boolean> => {
    ...
    fetchCustomers(); // Ambil data terbaru
    return true;
  ...
  const updateCustomer = useCallback(async (id: string, updates: UpdateCustomerInput): Promise<boolean> => {
  ...
  return (
    <CustomerContext.Provider value={{ customers, isLoading, addCustomer, getCustomerById, updateCustomer, deleteCustomer }}>
      {children}
